#ifndef _dgl_perspective_handler_h_
#define _dgl_perspective_handler_h_
...
/*!
 * @class DGLPerspectiveHandler DGLPerspectiveHandler.h dgl.h
 *
 * @brief DGL PerspectiveHandler class.  
 *
 ...
 */
class DGLAPI DGLPerspectiveHandler : public Producer::Camera::SceneHandler
{
 public:
  
  // generic constuctor
  DGLPerspectiveHandler();
 ...
 private:
  ...
  unsigned int m_w ;
  unsigned int m_h ;
  // viewport fov and autoaspect axis
  float m_fov ;
  float m_yfov ;
  bool m_recalc_yfov ;
