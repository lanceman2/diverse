...
void usage( int code )
{
	printf( "\nUsage: dSetEnv [options]\n\n" );
	printf( "dSetEnv provides a means to set environment variables using the\n"
			"dListener daemon running on a remote machine. The environment\n"
			"variable can be set for all clients listed in the\n"
	...
	printf( "    --computer hostname   as the hostname provided for which to set the\n" );
	printf( "    --hostname hostname   environment variable.\n\n" );
	printf( "    -e    name value      This mandatory option specifies the environment\n" );
	printf( "    --env name value      variable to be set with the specified value.\n\n" );
