...
static dtkAugment *dtkDSO_loader(dtkManager *manager, void *p)
{
  ...
  if(app->load("desktopDisplay:DGLkeyboardNavControl;trackballNav;desktopFlyNav;desktopHoverNav;caveDTKInput;gameNav;visWallScreens;visWallEyeSetter;buttonNavControl:wandJoystickNav"))
#else
  if(app->load("desktopDisplay:DGLkeyboardNavControl:trackballNav:caveDTKInput:visWallScreens:visWallEyeSetter:buttonNavControl:wandJoystickNav"))
#endif
  {
