...
IF( NOT FLTK_DIR )
	SET( FLTK_INCLUDE_SEARCH "" )
	FOREACH( dir ${FLTK_DIR_SEARCH2} )
		SET( FLTK_SEARCH ${FLTK_SEARCH} "${dir}/../" )
	ENDFOREACH(dir)
...
ELSE( EXISTS ${FLTK_DIR}/FLTKConfig.cmake )
	IF( FLTK_DIR )
		...
		IF( FLTK_FLUID_EXECUTABLE )
			GET_FILENAME_COMPONENT( FLTK_EXECUTABLE_DIRS "${FLTK_FLUID_EXECUTABLE}" PATH )
			SET( FLTK_SEARCH_PATH ${FLTK_EXECUTABLE_DIRS}/../include ${FLTK_EXECUTABLE_DIRS}/.. )
			SET( FLTK_LIBRARY_SEARCH_PATH ${FLTK_LIBRARY_SEARCH_PATH}
				${FLTK_EXECUTABLE_DIRS}/../lib )
			SET( FLTK_WRAP_UI 1 )
		...
		FIND_LIBRARY( FLTK_BASE_LIBRARY_DEBUG
				NAMES
				fltkd
				PATHS
				${FLTK_LIBRARY_SEARCH_PATH}
		...
		FIND_LIBRARY( FLTK_GL_LIBRARY_DEBUG
				NAMES fltkgld fltk_gld
				PATHS ${FLTK_LIBRARY_SEARCH_PATH}
				PATH_SUFFIXES
				lib
				lib32
		...
		FIND_LIBRARY( FLTK_FORMS_LIBRARY_DEBUG
				NAMES fltkformsd fltk_formsd
				PATHS ${FLTK_LIBRARY_SEARCH_PATH}
				PATH_SUFFIXES
				lib
				lib32
		...
		FIND_LIBRARY( FLTK_IMAGES_LIBRARY_DEBUG
				NAMES fltkimagesd fltk_imagesd
				PATHS ${FLTK_LIBRARY_SEARCH_PATH}
				PATH_SUFFIXES
				lib
				lib32
		...
		IF( FLTK_BASE_LIBRARY AND NOT FLTK_BASE_LIBRARY_DEBUG )
			SET( FLTK_BASE_LIBRARY_DEBUG ${FLTK_BASE_LIBRARY} CACHE FILEPATH "Debug version of fltk Library (use regular version if not available)" FORCE )
		ENDIF( FLTK_BASE_LIBRARY AND NOT FLTK_BASE_LIBRARY_DEBUG )
		IF( FLTK_GL_LIBRARY AND NOT FLTK_GL_LIBRARY_DEBUG )
			SET( FLTK_GL_LIBRARY_DEBUG ${FLTK_GL_LIBRARY} CACHE FILEPATH "Debug version of fltk_gl Library (use regular version if not available)" FORCE )
		ENDIF( FLTK_GL_LIBRARY AND NOT FLTK_GL_LIBRARY_DEBUG )
		IF( FLTK_FORMS_LIBRARY AND NOT FLTK_FORMS_LIBRARY_DEBUG )
			SET( FLTK_FORMS_LIBRARY_DEBUG ${FLTK_FORMS_LIBRARY} CACHE FILEPATH "Debug version of fltk_forms Library (use regular version if not available)" FORCE )
		ENDIF( FLTK_FORMS_LIBRARY AND NOT FLTK_FORMS_LIBRARY_DEBUG )
		IF( FLTK_IMAGES_LIBRARY AND NOT FLTK_IMAGES_LIBRARY_DEBUG )
			SET( FLTK_IMAGES_LIBRARY_DEBUG ${FLTK_IMAGES_LIBRARY} CACHE FILEPATH "Debug version of fltk_images Library (use regular version if not available)" FORCE )
		ENDIF( FLTK_IMAGES_LIBRARY AND NOT FLTK_IMAGES_LIBRARY_DEBUG )
