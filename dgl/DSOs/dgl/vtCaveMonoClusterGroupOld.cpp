...
#ifdef DGL_ARCH_WIN32
  SetEnvironmentVariable("DADS_DSO_FILES_dads1", "vtCaveMonoDisplayFront");
  SetEnvironmentVariable("DADS_DSO_FILES_dads2", "vtCaveMonoDisplayFloor");
  SetEnvironmentVariable("DADS_DSO_FILES_dads3", "vtCaveMonoDisplayRight");
  SetEnvironmentVariable("DADS_DSO_FILES_dads4", "vtCaveMonoDisplayLeft");
#elif defined IRIX
  putenv("DADS_DSO_FILES_dads1=vtCaveMonoDisplayFront");
  putenv("DADS_DSO_FILES_dads2=vtCaveMonoDisplayFloor");
  putenv("DADS_DSO_FILES_dads3=vtCaveMonoDisplayRight");
  putenv("DADS_DSO_FILES_dads4=vtCaveMonoDisplayLeft");
#else
  setenv("DADS_DSO_FILES_dads1", "vtCaveMonoDisplayFront",1);
  setenv("DADS_DSO_FILES_dads2", "vtCaveMonoDisplayFloor",1);
  setenv("DADS_DSO_FILES_dads3", "vtCaveMonoDisplayRight",1);
  setenv("DADS_DSO_FILES_dads4", "vtCaveMonoDisplayLeft",1);
#endif
